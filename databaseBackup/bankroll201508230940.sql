...
--
-- Host: localhost
-- Generation Time: 2015-08-23 03:35:56
-- 服务器版本： 5.6.20
-- PHP Version: 5.5.15
...
INSERT INTO `postdata` (`id`, `data`, `type`, `name`, `reason`, `money`, `state`, `userID`) VALUES
...
(20, '2015-08-19', '散油采购', '益海（兖州）粮油工业有限公司', '付花生油款', 457134, '完成', 12);
...
INSERT INTO `user` (`id`, `username`, `department`, `userid`, `privilege`, `score`) VALUES
(1, '黎晓慧', '贸易部', 12, 1, 100);
